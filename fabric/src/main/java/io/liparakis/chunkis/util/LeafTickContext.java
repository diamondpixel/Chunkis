 ...
 * <p>
 * This utility class provides a thread-safe mechanism to track whether the
 * current
 * thread is executing within a "leaf tick" context. A leaf tick typically
 * refers to
 ...
 * <li>Context state doesn't leak between different operations on the same
 * thread</li>
 * </ul>
 * </p>
 * <p>
