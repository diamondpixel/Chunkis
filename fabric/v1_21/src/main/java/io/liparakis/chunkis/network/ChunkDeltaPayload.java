 ...
 * <p>
 * This record encapsulates chunk modification data along with chunk
 * coordinates,
 * designed for efficient serialization and deserialization in Minecraft's
 * networking system.
 * </p>
 *
 * <h2>Performance Optimizations:</h2>
 * <ul>
 * <li>Reordered field writes to minimize buffer operations (primitives before
 * arrays)</li>
 * <li>Direct array reference (no defensive copy) - caller responsible for
 * immutability</li>
...
public record ChunkDeltaPayload(byte[] data, int chunkX, int chunkZ) implements CustomPayload {
     ...
     * buffer resizing operations. Small fixed-size values are written first to
     * allow
